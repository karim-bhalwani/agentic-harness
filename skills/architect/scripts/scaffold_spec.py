...
def scaffold_spec(config: SpecConfig) -> str:
    ...
    """
    return f"""# Specification: {config.module_name}
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Scaffold a SPEC.md for a module or service"
    )
    ...
    parser.add_argument(
        "--outputs", nargs="*", default=[], help="Output types/contracts"
    )
    parser.add_argument(
        "--consumers", nargs="*", default=[], help="Modules that call this"
    )
    parser.add_argument(
        "--dependencies", nargs="*", default=[], help="Modules this calls"
    )
    parser.add_argument(
        "--constraints", nargs="*", default=[], help="Non-functional requirements"
    )
